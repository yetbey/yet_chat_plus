...
class ErrorConstants {
 ...
 static const String updatePostUnsuccessMessage = 'Gönderi güncellenirken bir sorun oluştu.';
 ...
 static const String createPostUnsuccessMessage = 'Gönderi paylaşılırken bir hata oluştu';
 ...
 static const String deleteUnsuccessMessage = 'Gönderi silinirken bir sorun oluştu.';
 static const String loadPostUnsuccess = 'Gönderi Yüklenemedi';

 /// Comments
 static const String getCommentsError = 'Gönderi güncellenirken bir sorun oluştu.';
 static const String addCommentError = 'Yorum ekleme hatası';
 static const String getCommentError = 'Yorumları getirme hatası';
 static const String addCommentUnsuccess = 'Yorum eklenirken bir sorun oluştu.';
}